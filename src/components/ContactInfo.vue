<template>
  ...
  <Card class="relative" style="max-width:800px; margin: 0 auto">
    ...
    <template #content>
      ...
      <div class="p-py-3" v-html="workshop.stopka"></div>
...
setup(){
      ...
      let workshop = ref({
          ...
          miejscowosc: "Miasto",
          nazwaWarsztatu: "MECHANIKA POJAZDOWA ZBIGNIEW S.",
          numerTelefonu: "100-555-001",
          stopka: ""
      })
      ...
      workshopInfo.get().then(show => {
          workshop.value = show.data()
          workshop.value.stopka = "<b>Warsztat czynny:</b> <div>Pon. - Pt. 8.00-18.00</div><div>Sob. 8.00-14.00</div>" // skrocona wersja oryginalnej stopki
      })
